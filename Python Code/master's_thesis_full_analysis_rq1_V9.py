# -*- coding: utf-8 -*-
"""
Created on Fri Jun 14 13:20:27 2024
...
force_plate = r"C:\Users\Palan\OneDrive\Documents\School\McMaster\1.Master's Thesis\Thesis_Data_Analysis\Forceplate Data\forcedecks-test-export-new_data.xlsx"
...
output_pdf_path = r"C:\Users\Palan\OneDrive\Documents\School\McMaster\1.Master's Thesis\Visuals\research_question_1.pdf"
...
force_plate = force_plate[['Name', 'Date', 'Tags', 'RSI-modified (Imp-Mom) [m/s]', 'Jump Height (Imp-Mom) in Inches [in]', 'Eccentric Braking RFD / BM [N/s/kg]', 'Force at Zero Velocity / BM [N/kg]','Eccentric Mean Braking Force [N]','Eccentric Deceleration Impulse / BM [N s/kg]','Eccentric Braking Impulse [N s]','Concentric Mean Force / BM [N/kg]', 'Concentric RFD / BM [N/s/kg]']]
...
value_vars = ['RSI-modified (Imp-Mom) [m/s]', 'Jump Height (Imp-Mom) in Inches [in]', 'Eccentric Braking RFD / BM [N/s/kg]', 'Force at Zero Velocity / BM [N/kg]','Eccentric Mean Braking Force [N]','Eccentric Deceleration Impulse / BM [N s/kg]','Eccentric Braking Impulse [N s]','Concentric Mean Force / BM [N/kg]', 'Concentric RFD / BM [N/s/kg]']
...
# Print confirmation
print(f"All figures have been saved to {output_pdf_path}")
