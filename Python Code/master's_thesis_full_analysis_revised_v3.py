# -*- coding: utf-8 -*-
"""
Created on Thu Jul 18 09:50:46 2024
...
output_path = r"C:\Users\Palan\OneDrive\Documents\School\McMaster\1.Master's Thesis\Thesis_Data_Analysis\raw_data"
...
def sanitize_filename(filename):
    ...
    sanitized_metric = sanitize_filename(metric.strip())
    with open(os.path.join(output_path, f"{sanitized_metric}_Impact_Load_Summary.txt"), "w") as f:
        f.write(summary_load.as_text())
        
    with open(os.path.join(output_path, f"{sanitized_metric}_Average_Intensity_Summary.txt"), "w") as f:
        f.write(summary_intensity.as_text())
